...
return function( ... )
	...
	-- Particles
	local Hit = Particles["Ice Meteors"].IceHit:Clone()
	...
	-- Crack
	local Ground = Particles["Ice Meteors"].Ground:Clone()
	...
	TweenService:Create(Ground, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = Vector3.new(11, 0.1, 11)}):Play()
	
	task.wait(0.585)
	
	TweenService:Create(Ground, TweenInfo.new(0.7, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = Vector3.new(10.5, 0.1, 10.5)}):Play()
