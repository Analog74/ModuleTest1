...
return function(...) 
	...
	local Hit = Particles.LightningHit:Clone()
	Hit.Position = Parameters[1]
	Hit.Parent = workspace.Effects
	
	local Sparks = Particles.LightningSparks:Clone()
	Sparks.Position = Parameters[1]
	Sparks.Parent = workspace.Effects
	Debris:AddItem(Sparks, 1.1)
